...
import com.app.tp.layerchatintegration.BuildConfig;
...
public class PushNotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (intent.getAction().equals(ACTION_PUSH)) {
            ...
            Util.waitForContent(MyApp.getLayerClient().connect(), messageId,
    ...
    public static class Notifications {
        ...
        private void update(Context context, Conversation conversation, Message message) {
            ...
            String conversationTitle = Util.getConversationTitle(MyApp.getLayerClient(), MyApp.getParticipantProvider(), conversation);
            ...
            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context)
                    .setSmallIcon(R.drawable.bc_launcher)
            ...
            Intent clickIntent = new Intent(context, ChatMessageScreen.class)
