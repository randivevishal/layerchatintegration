...
public class ConversationViewController implements View.OnClickListener, LayerChangeEventListener
    ...
    public ConversationViewController(HomeScreen ma, LayerClient client) {
        ...
        //Change the layout
        ma.setContentView(R.layout.activity_conversation_view);
    ...
    public static String getInitialMessage() {
        return "Hey, everyone! This is your friend, " + Constants.USER_ID;
    }
    ...
    private void sendButtonClicked() {
        ...
        if (activeConversation == null) {
            ...
            if (activeConversation == null) {
                activeConversation = layerClient.newConversation(ChatUsers.getAllParticipants());
            }
        }
