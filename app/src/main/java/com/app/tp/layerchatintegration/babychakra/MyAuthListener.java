...
public class MyAuthListener implements LayerAuthenticationListener {
    ...
    private static final String TAG = MyAuthListener.class.getSimpleName();

//    private HomeScreen homeScreen;

    GenericListener<Object> objectGenericListener;
    public MyAuthListener(GenericListener<Object> objectGenericListener) {
    ...
    public void onAuthenticationChallenge(final LayerClient layerClient, final String nonce) {
        final String mUserId = ""+Constants.USER_ID;//+"VishaRandive";
