...
//        }
        ...
        if ((layerClient != null) && hasCredentials()) {
            ...
            intent.putExtra(ResumeActivity.EXTRA_LOGGED_OUT_ACTIVITY_CLASS_NAME, BabychakraChatLoginActivity.class.getName());
            from.startActivity(intent);
            return true;
        }
        ...
        Intent intent = new Intent(from, BabychakraChatLoginActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
        from.startActivity(intent);
        return true;
    }
            ...
            (new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try
                    {
                        ...
                        nameValuePairs.add(new BasicNameValuePair("user_id", ""+Constants.USER_ID));
...
//            String result = Utility.streamToString(in);
//            in.close();
