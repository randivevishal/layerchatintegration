...
public class ChatMessageScreen extends BaseActivity {
    ...
    public ChatMessageScreen() {
        super(R.layout.activity_chat_message, R.menu.menu_messages_list, R.string.title_select_conversation, true);
    }
        ...
        mMessagesList = ((AtlasMessagesRecyclerView) findViewById(R.id.messages_list))
                ...
                .setOnMessageSwipeListener(new SwipeableItem.OnSwipeListener<Message>() {
                    ...
                    public void onSwipe(final Message message, int direction) {
                        new AlertDialog.Builder(ChatMessageScreen.this)
...
//                intent.putExtra(Constants.LAYER_CONVERSATION_KEY, mConversation.getId());
